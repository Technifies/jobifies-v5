...
export const metadata: Metadata = {
  title: 'Forgot Password - Jobifies',
  description: 'Reset your Jobifies account password. Enter your email to receive password reset instructions.',
  keywords: 'forgot password, reset password, jobifies, account recovery',
};
