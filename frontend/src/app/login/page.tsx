...
export const metadata: Metadata = {
  title: 'Sign In - Jobifies',
  description: 'Sign in to your Jobifies account to access job opportunities and manage your profile.',
  keywords: 'login, sign in, jobifies, jobs, career',
};
